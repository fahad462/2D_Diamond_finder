...
public class Content {
	...
	public static BufferedImage[][] MENUBG = load("/HUD/menuscreen1.png", 128, 144);
	public static BufferedImage[][] BAR = load("/HUD/bar1.png", 128, 16);
	
	public static BufferedImage[][] PLAYER = load("/Sprites/playersprites1.png", 16, 16);
	//public static BufferedImage[][] PLAYER = load("/Sprites/w.png",16,16);

	public static BufferedImage[][] DIAMOND = load("/Sprites/diamond1.png", 16, 16);
	...
	public static BufferedImage[][] load1 (String s) {
		try {
			BufferedImage[][] ret;
